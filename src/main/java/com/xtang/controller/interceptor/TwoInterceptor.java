...
public class TwoInterceptor implements HandlerInterceptor  {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		if (true) {
			returnErrorResponse(response, XTangJSONResult.errorMsg("被two拦截..."));
		}
	...
	public void returnErrorResponse(HttpServletResponse response, XTangJSONResult result) throws IOException, UnsupportedEncodingException {
